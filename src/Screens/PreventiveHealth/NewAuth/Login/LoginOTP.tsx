...
type Nav = NativeStackNavigationProp<RootStackParamList, 'LoginOTP'>;
type OtpRoute = RouteProp<RootStackParamList, 'LoginOTP'>;
...
const LoginOTP: React.FC = () => {
  ...
  const handleVerify = useCallback(async () => {
    ...
    try {
      console.log('======================================');
      console.log('[PreventiveAuthLogin] VERIFY OTP REQUEST');
      console.log('Mobile:', mobile);

      const response = await verifyPatientAuthOtp({
        mobile,
        otp: otpDigits,
      });
      ...
      console.log('[PreventiveAuthLogin] VERIFY OTP RESPONSE');
      ...
      console.log('UHID:', loginData?.uhid);
      console.log('Name:', loginData?.first_name, loginData?.last_name);
      console.log('Patients:', loginData?.patients);
      console.log('======================================');
      ...
      if (responseData?.success) {
        ...
        if (accessToken && refreshToken && loginData?.user_id) {
      ...
      console.log('======================================');
      console.log('[PreventiveAuthLogin] VERIFY OTP ERROR');
  ...
  const handleResendOtp = useCallback(async () => {
    ...
    try {
      console.log('======================================');
      console.log('[PreventiveAuthLogin] RESEND OTP REQUEST');
      console.log('Mobile:', mobile);

      const response = await sendPatientAuthOtp({ mobile });
      const data = response?.data;

      console.log('[PreventiveAuthLogin] RESEND OTP RESPONSE');
      ...
      console.log('======================================');
      console.log('[PreventiveAuthLogin] RESEND OTP ERROR');
      console.log('Error response:', JSON.stringify(errorData, null, 2));
      console.log('======================================');
  ...
  }, [mobile, isResending, showPopup, closePopup]);
