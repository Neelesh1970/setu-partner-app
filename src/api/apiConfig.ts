 ...
 */
export const BASE_URL = 'https://api.setuai.com/preventive-health/api/v1';
// export const BASE_URL =
//   'https://explicit-wearing-copied-chemistry.trycloudflare.com/api/v1';

// AUTH 7005 — registration uses a different host (see `registerAxiosInstance`).
export const REGISTER_BASE_URL = 'https://api.setuai.com/api/users/';
